...
class Matrix {
   ...
   public:
    ...
    template <typename Type2>
    friend Matrix<Type2> operator+(const Matrix<Type2>& mat1, const Matrix<Type2>& mat2);
    template <typename Type2>
    friend Matrix<Type2> operator-(const Matrix<Type2>& mat1, const Matrix<Type2>& mat2);
    template <typename Type2>
    friend Matrix<Type2> operator*(const Matrix<Type2>& mat1, const Matrix<Type2>& mat2);
    template <typename Type2>
    friend Matrix<Type2> operator+(const Matrix<Type2>& mat2, const Type2 element);
    template <typename Type2>
    friend Matrix<Type2> operator-(const Matrix<Type2>& mat2, const Type2 element);
    template <typename Type2>
    friend Matrix<Type2> operator*(const Matrix<Type2>& mat2, const Type2 element);
    ...
    friend Matrix<Type2> operator/(const Matrix<Type2>& mat2, const Type2 element);
    template <typename Type2>
    friend Matrix<Type2> operator+(const Type2 element, const Matrix<Type2>& mat2);
    template <typename Type2>
    friend Matrix<Type2> operator-(const Type2 element, const Matrix<Type2>& mat2);
    template <typename Type2>
    friend Matrix<Type2> operator*(const Type2 element, const Matrix<Type2>& mat2);
